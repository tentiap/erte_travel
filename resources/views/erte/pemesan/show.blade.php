        ...
        <div class="box">
            <div class="box-body">
                    ...
                    <div style="position: absolute; right: 0;">
                        <a href="/pemesan/edit/{{ $pemesan->id_users }}" class="btn btn-md" ><i class="fa fa-edit"></i> Edit</a>
                        <a class="btn btn-md" data-toggle='modal' data-target='#konfirmasi_hapus' data-href="/pemesan/delete/{{ $pemesan->id_users }}"><i class="fa fa-trash"></i> Hapus Pemesan</a>
                        <a href="/pemesan/" class="btn btn-md" ><i class="fa fa-list"></i> List Pemesan</a>
                        <a href="/pemesan/create/" class="btn btn-md" ><i class="fa  fa-plus-circle"></i> Tambah Pemesan</a>                       
                    </div>
                        </br>
                    ...
                    <script src="https://code.jquery.com/jquery-3.1.1.min.js"></script>
                        ...
                        <div class = "form-group">
                            ...
                            <input type="text" name="jenis_kelamin" class="form-control" placeholder="Jenis Kelamin" value="{{$users->jenis_kelamin}}"> 
                            "readonly>                                               
                      </div>

                        <div class="form-group">
                            <label>Alamat</label>
                            <input type="text" name="alamat" class="form-control" placeholder="Alamat" value="{{$users->pemesan->alamat}}" readonly>
